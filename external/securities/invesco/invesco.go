...
import (
	...
	"stocks/external/securities/invesco/template1"
	"stocks/external/securities/invesco/template2"
	"stocks/external/securities/invesco/template3"
	"stocks/external/securities/invesco/template4"
	"stocks/models"
	"stocks/utils"
	"strings"
)
